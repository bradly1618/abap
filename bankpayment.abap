...
DATA: LT_REGUH          TYPE STANDARD TABLE OF REGUH WITH DEFAULT KEY,
      LT_REGUP          TYPE STANDARD TABLE OF REGUP WITH DEFAULT KEY,
      LT_GIRO           TYPE STANDARD TABLE OF REGUH WITH DEFAULT KEY,
      LT_RENTASTT_REGUH TYPE STANDARD TABLE OF REGUH WITH DEFAULT KEY,
      LT_RENTASTT_REGUP TYPE STANDARD TABLE OF REGUP WITH DEFAULT KEY,
      LT_GIRO_FILE      TYPE STANDARD TABLE OF TY_GIRO_OCBC WITH DEFAULT KEY,
      LT_LEAF           TYPE STANDARD TABLE OF SETLEAF WITH DEFAULT KEY,
      LS_REGUH          TYPE REGUH,
...
DATA: LS_RENTASTT_REGUH TYPE REGUH,
      ...
      LT_RENTASTT       TYPE STANDARD TABLE OF TY_RENTASTT_OCBC WITH DEFAULT KEY.

DATA: LT_JOMPAY_REGUH TYPE STANDARD TABLE OF REGUH WITH DEFAULT KEY,
      LT_JOMPAY_REGUP TYPE STANDARD TABLE OF REGUP WITH DEFAULT KEY,
      LS_JOMPAY_REGUH TYPE REGUH,
      LS_JOMPAY       TYPE TY_JOMPAY_OCBC,
      LT_JOMPAY       TYPE STANDARD TABLE OF TY_JOMPAY_OCBC WITH DEFAULT KEY.

DATA: LT_DUITNOW_REGUH TYPE STANDARD TABLE OF REGUH WITH DEFAULT KEY,
      LT_DUITNOW_REGUP TYPE STANDARD TABLE OF REGUP WITH DEFAULT KEY,
      LS_DUITNOW_REGUH TYPE REGUH,
      LS_DUITNOW       TYPE TY_DUITNOW_OCBC,
      LT_DUITNOW       TYPE STANDARD TABLE OF TY_DUITNOW_OCBC WITH DEFAULT KEY.


DATA: LT_ZBANKREQ TYPE STANDARD TABLE OF TY_ZBANKREQ WITH DEFAULT KEY.
*----------------------------------------------------------------------*
* Constant
*----------------------------------------------------------------------*
...
*Detail
  CLEAR: LV_TOTAL, LV_TOT_REC, LV_TOTAL_AMT.
...
FORM TRANSFER_DATASET_GIRO .
  ...
  LOOP AT LT_GIRO_FILE INTO DATA(LS_GIRO_FILE).
    TRANSFER LS_GIRO_FILE-DETAIL TO LV_FILENAME LENGTH 480.
  ENDLOOP.
...
FORM PROCESS_RENTASTT.
  ...
  CLEAR: LT_RENTASTT_REGUP, LT_ZBANKREQ, LT_RENTASTT.
  ...
  LOOP AT LT_RENTASTT_REGUP INTO DATA(LS_RENTASTT_REGUP).
    ...
    IF LS_RENTASTT_REGUH-ZBVTY = 'RT'.

      WRITE '' TO LS_RENTASTT+358(35).

    ELSEIF LS_RENTASTT_REGUH-ZBVTY = 'TT'.
...
FORM TRANSFER_DATASET_RENTASTT.
  ...
  OPEN DATASET LV_FILENAME FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.
  LOOP AT LT_RENTASTT INTO DATA(LS_RENTASTT_LINE).
    IF LS_RENTASTT_LINE-DETAIL+0(3) = 'INV'.
      TRANSFER  LS_RENTASTT_LINE-DETAIL TO LV_FILENAME LENGTH 75.
    ELSE.
      TRANSFER  LS_RENTASTT_LINE-DETAIL TO LV_FILENAME LENGTH 1362.
    ENDIF.
  ENDLOOP.
  CLOSE DATASET LV_FILENAME.
...
FORM PROCESS_JOMPAY.
  ...
  CLEAR: LT_JOMPAY_REGUP, LT_ZBANKREQ.
...
FORM TRANSFER_DATASET_JOMPAY.
  ...
  OPEN DATASET LV_FILENAME FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.
  LOOP AT LT_JOMPAY INTO DATA(LS_JOMPAY_LINE).
    TRANSFER  LS_JOMPAY_LINE-DETAIL TO LV_FILENAME LENGTH 480.
  ENDLOOP.
  CLOSE DATASET LV_FILENAME.
...
FORM PROCESS_DUITNOW.
  DATA: LS_ZBANKREQ TYPE TY_ZBANKREQ,
        LS_DUITNOW_LINE TYPE TY_DUITNOW_OCBC.
  ...
  CLEAR: LT_DUITNOW_REGUP, LT_ZBANKREQ.
  ...
  LOOP AT LT_DUITNOW_REGUP INTO DATA(LS_DUITNOW_REGUP).
    ...
    LS_DUITNOW_LINE-DETAIL = LV_DUITNOW_STR.
    APPEND LS_DUITNOW_LINE TO LT_DUITNOW.
    CLEAR: LV_DUITNOW_STR, LS_DUITNOW_LINE.
...
FORM TRANSFER_DATASET_DUITNOW.
  ...
  OPEN DATASET LV_FILENAME FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.
  LOOP AT LT_DUITNOW INTO DATA(LS_DUITNOW_LINE).
    TRANSFER  LS_DUITNOW_LINE-DETAIL TO LV_FILENAME.
  ENDLOOP.
  CLOSE DATASET LV_FILENAME.
